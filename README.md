...
```
src/gz systemcrash https://systemcrash.github.io/systemcrash-openwrt-repo/openwrt-24.10/packages/<arch>/
```
...
echo src/gz systemcrash https://systemcrash.github.io/systemcrash-openwrt-repo/snapshots/packages/<arch>/ >> /etc/opkg/customfeeds.conf
```
...
```
https://systemcrash.github.io/systemcrash-openwrt-repo/snapshots/packages/<arch>/packages.adb
```
...
echo https://systemcrash.github.io/systemcrash-openwrt-repo/snapshots/packages/<arch>/packages.adb >> /etc/apk/repositories.d/customfeeds.list
```
